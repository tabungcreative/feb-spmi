...
@section('content')
    ...
    <a class="btn btn-primary mb-3" href="{{ route('penelitian.create') }}">
        <i class="bx bx-plus-circle me-1"></i> Tambah Penelitian
    </a>
    <div class="card">
        <div class="d-flex align-items-center flex-row justify-content-around">
            <h5 class="card-header flex-grow-1">List Penelitian</h5>
