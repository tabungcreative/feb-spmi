...
@section('content')
    ...
    @can('admin')
    <a class="btn btn-primary mb-3" href="{{ route('dokumen-mutu.create.id', $penjaminanMutu->id) }}">
        <i class="bx bx-plus-circle me-1"></i> Tambah {{ $penjaminanMutu->nama }}
    </a>
    @endcan
    <div class="card">
        <div class="d-flex align-items-center flex-row justify-content-around">
            <h5 class="card-header flex-grow-1">Dokumen {{ $penjaminanMutu->nama }}</h5>
